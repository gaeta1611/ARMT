                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        {{ Form::text('nom_entreprise',old('nom_entreprise'),[
                                    ...
                                    <div class="form-group">
                                        ...
                                        {{ Form::text('personne_contact',old('personne_contact'),[
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        {{ Form::text('localite',old('localite'),[
