...
return [
    ...
    */
    ...
    'record_saved' => "L' :record a bien été enregistré",
    ...
    'date' => 'date',
    'titles' => [
        'list_client_prospect'=> "Liste des Clients & Prospect ",
    ...
    'error_cv_save' => "Erreur lors de l'enregristrement du document (CV)!",
    'error_general' => "Une erreur s'est produite lors de l'enregristrement!",
    ...
    'done_status' => "Veuillez spécifier le status",
    ...
    'error_rapport_save' => "Erreur lors de l'enregristrement du document (rapport interview)!",
    'error_lettre_save' => "Erreur lors de l'enregristrement du document (lettre de motivation)!",
    ...
    //'impossible_emploi_delete' => "Une erreur s'est produite lors de l'enregristrement de la candidature $candidature->id!",
    ...
    'format_incorrect' => "Format incorrecte pour le typ d'interview",
    ...
    'error_type_status' => "Veuillez entrer le type de status",
    'error_contract_save' => "Erreur lors de l'enregristrement du document (contrat)!",
    'success_mission_save' => "La mission a bien été enregistrée",
    'error_job_save' => "Erreur lors de l'enregristrement du document (job description)!",
    'error_offre_save' => "Erreur lors de l'enregristrement du document (offre)!",
